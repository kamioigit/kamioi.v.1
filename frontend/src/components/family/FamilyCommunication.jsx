...
const FamilyCommunication = ({ user, onOpenCommunication }) => {
      ...
      <div className={`${getCardClass()} rounded-xl p-6`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button className="p-4 rounded-lg border border-white/10 hover:bg-white/5 transition-colors text-left">
            ...
            <p className={`font-medium ${getTextClass()}`}>Family Members</p>
            <p className={`text-sm ${getSubtextClass()}`}>View all family members</p>
          </button>
