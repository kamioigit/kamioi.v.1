...
def update_ports_in_file(file_path):
    try:
        ...
        updated_content = re.sub(r'http://127\.0\.0\.1:5000', 'http://127.0.0.1:5001', content)
        updated_content = re.sub(r'http://localhost:5000', 'http://localhost:5001', updated_content)
