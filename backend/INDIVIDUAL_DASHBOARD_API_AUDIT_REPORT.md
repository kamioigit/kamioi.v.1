# Individual Dashboard API Endpoint Audit Report
...
- `http://127.0.0.1:5000/api/user/ai/insights` (AIInsights.jsx) - fetch
- `http://127.0.0.1:5000/api/user/rewards` (AIInsights.jsx) - fetch
- `http://127.0.0.1:5000/api/analytics/recommendation-click` (AIInsights.jsx) - fetch
- `http://127.0.0.1:5000/api/user/ai-insights?timeframe=${selectedTimeframe}` (AIRecommendations.jsx) - fetch
- `http://127.0.0.1:5000/api/user/active-ad` (DashboardSidebar.jsx) - fetch
- `/api/receipts/upload` (ReceiptUpload.jsx) - fetch
- `/api/receipts/${receiptId}/process` (ReceiptUpload.jsx) - fetch
- `/api/receipts/${receiptId}/allocate` (ReceiptUpload.jsx) - fetch
- `/api/transactions/create` (ReceiptUpload.jsx) - fetch
- `http://127.0.0.1:5000/api/user/profile` (Settings.jsx) - fetch
- `http://127.0.0.1:5000/api/user/statements` (Settings.jsx) - fetch
- `http://127.0.0.1:5000/api/user/profile` (Settings.jsx) - fetch
- `http://127.0.0.1:5000/api/user/transactions` (UserTransactions.jsx) - fetch
- `http://127.0.0.1:5000/api/transactions/process` (UserTransactions.jsx) - fetch
- `http://127.0.0.1:5000/api/transactions/bulk-upload` (UserTransactions.jsx) - fetch
- `http://127.0.0.1:5000/api/user/export/transactions` (UserTransactions.jsx) - fetch
- `http://127.0.0.1:5000/api/mappings/submit` (UserTransactions.jsx) - fetch
