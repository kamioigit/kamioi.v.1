...
# Fix the /api/admin/llm-center/mappings endpoint to include AI processing fields with correct column indices
...
# Find the specific section for the mappings endpoint and replace it
old_section = """            mappings_list.append({
                'id': mapping[0],
...
new_section = """            mappings_list.append({
                'id': mapping[0],
                'transaction_id': mapping[1],
                'merchant_name': mapping[2],
                'ticker': mapping[3],
...
print("Fixed /api/admin/llm-center/mappings endpoint with correct AI processing field column indices")
