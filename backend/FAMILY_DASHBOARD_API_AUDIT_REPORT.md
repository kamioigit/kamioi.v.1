# Family Dashboard API Endpoint Audit Report
...
- `http://127.0.0.1:5000/api/family/ai-insights` (FamilyAIInsights.jsx) - fetch
- `http://127.0.0.1:5000/api/family/mapping-history` (FamilyAIInsights.jsx) - fetch
- `http://127.0.0.1:5000/api/family/rewards` (FamilyAIInsights.jsx) - fetch
- `http://127.0.0.1:5000/api/family/leaderboard` (FamilyAIInsights.jsx) - fetch
- `http://127.0.0.1:5000/api/analytics/recommendation-click` (FamilyAIInsights.jsx) - fetch
- `http://127.0.0.1:5000/api/family/members` (FamilyMembers.jsx) - fetch
- `http://127.0.0.1:5000/api/family/members` (FamilyMembers.jsx) - fetch
- `http://127.0.0.1:5000/api/family/members/${selectedMember.id}` (FamilyMembers.jsx) - fetch
- `http://127.0.0.1:5000/api/family/members/${memberId}/invite` (FamilyMembers.jsx) - fetch
- `http://127.0.0.1:5000/api/family/members` (FamilyOverview.jsx) - fetch
- `http://127.0.0.1:5000/api/family/portfolio` (FamilyOverview.jsx) - fetch
- `http://127.0.0.1:5000/api/family/goals` (FamilyOverview.jsx) - fetch
- `http://127.0.0.1:5000/api/family/settings` (FamilySettings.jsx) - fetch
- `http://127.0.0.1:5000/api/family/settings` (FamilySettings.jsx) - fetch
- `http://127.0.0.1:5000/api/family/statements` (FamilySettings.jsx) - fetch
- `http://127.0.0.1:5000/api/lookup/ticker` (FamilyTransactions.jsx) - fetch
- `http://127.0.0.1:5000/api/transactions/process` (FamilyTransactions.jsx) - fetch
- `http://127.0.0.1:5000/api/mappings/transaction/${transactionId}` (FamilyTransactions.jsx) - fetch
- `http://127.0.0.1:5000/api/family/export/transactions` (FamilyTransactions.jsx) - fetch
- `http://127.0.0.1:5000/api/mappings/submit` (FamilyTransactions.jsx) - fetch
